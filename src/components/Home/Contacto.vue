    ...
    <div class="" id="contacto">
        <b-container style="padding-bottom: 30px; padding-top: 30px">
            <b-row>
                ...
                <b-col sm="12" md="4">
                    <div class="russo go-color" style="letter-spacing:3px; text-align: left">
                        ¿QUIERES COTIZAR?
                    </div>
                    <div>
                        <p style="text-align: left">
                            ...
                            <a href="https://www.facebook.com/GorilasOnline/" target="_blank"><i
                                    style="margin-top:20px;font-size: 1.5em" class="fab fa-facebook-f"></i></a>
                            <!--<a href="https://www.facebook.com/GorilasOnline/" target="_blank"><i-->
                            <!--style="margin-top:20px;margin-left: 10px; font-size: 1.5em"-->
                            <!--class="fab fa-instagram"></i></a>-->
                            <a href="https://twitter.com/gorilasonline" target="_blank"><i
                                    style="margin-top:20px;margin-left: 10px; font-size: 1.5em"
...
<style scoped>
    ...
    #send-btn:hover{
        background-color: transparent; border: 2px solid #f16338; color: #f16338
    }
</style>